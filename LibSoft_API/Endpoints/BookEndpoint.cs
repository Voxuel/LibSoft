...
// Creates new book or adds another already existing copy with the same name and author.
        ...
        app.MapGet("/api/book/author/{auth}", async (IBookRepository repo, IMapper mapper, string auth) =>
        {
            var response = new APIResponse() {IsSuccess = false, StatusCode = HttpStatusCode.BadRequest};
        ...
        app.MapGet("/api/book/genre/{genre}", async (IBookRepository repo, IMapper mapper, string genre) =>
        {
            var response = new APIResponse() {IsSuccess = false, StatusCode = HttpStatusCode.BadRequest};
